...
appConfig.apiRootUrl = base_url_project;
                            ...
                            "content@app": {
                                ...
                                resolve: {
                                    projects: function ($http, APP_CONFIG) {
                                        return $http.get(APP_CONFIG.apiRootUrl + api_url + '/project-list.json')
                                    }
                                }
                            }
                        },
...
angular.module('app').factory('activityService', function ($http, $log, APP_CONFIG) {
    ...
    function getActivities(callback) {
        ...
        $http.get(APP_CONFIG.apiRootUrl + api_url + '/activities/activity.json').success(function (data) {
    ...
    function getActivitiesByType(type, callback) {
        ...
        $http.get(APP_CONFIG.apiRootUrl + api_url + '/activities/activity-' + type + '.json').success(function (data) {
...
angular.module('app').factory('Project', function ($http, APP_CONFIG) {
    return {
        list: $http.get(APP_CONFIG.apiRootUrl + api_url + '/projects.json')
    }
});
"use strict";
...
angular.module('app.inbox').factory('InboxMessage', function ($resource, APP_CONFIG) {
    var InboxMessage = $resource(APP_CONFIG.apiRootUrl + api_url + '/messages.json/:id', {'id': '@_id'}, {
        get: {
            url: APP_CONFIG.apiRootUrl + api_url + '/message.json',
            isArray: false
        }
    });
...
angular.module('app').factory('Language', function ($http, APP_CONFIG) {
    ...
    function getLanguage(key, callback) {
        ...
        $http.get(APP_CONFIG.apiRootUrl + api_url + '/langs/' + key + '.json').success(function (data) {
    ...
    function getLanguages(callback) {
        ...
        $http.get(APP_CONFIG.apiRootUrl + api_url + '/languages.json').success(function (data) {
...
angular.module('app.maps').factory('SmartMapStyle', function ($q, $http, APP_CONFIG) {
    ...
    var styles = {
        'colorful': {name: 'Colorful', url: APP_CONFIG.apiRootUrl + api_url + '/maps/colorful.json'},
        'greyscale': {name: 'greyscale', url: APP_CONFIG.apiRootUrl + api_url + '/maps/greyscale.json'},
        'metro': {name: 'metro', url: APP_CONFIG.apiRootUrl + api_url + '/maps/metro.json'},
        'mono-color': {name: 'mono-color', url: APP_CONFIG.apiRootUrl + api_url + '/maps/mono-color.json'},
        'monochrome': {name: 'monochrome', url: APP_CONFIG.apiRootUrl + api_url + '/maps/monochrome.json'},
        'nightvision': {name: 'Nightvision', url: APP_CONFIG.apiRootUrl + api_url + '/maps/nightvision.json'},
        'nightvision-highlight': {name: 'nightvision-highlight', url: APP_CONFIG.apiRootUrl + api_url + '/maps/nightvision-highlight.json'},
        'old-paper': {name: 'Old Paper', url: APP_CONFIG.apiRootUrl + api_url + '/maps/old-paper.json'}
    };
...
angular.module('app.chat').factory('ChatApi', function ($q, $rootScope, User, $http, APP_CONFIG) {
    ...
    $http.get(APP_CONFIG.apiRootUrl + api_url + '/chat.json').then(function (res) {
...
angular.module('app').factory('Todo', function (Restangular, APP_CONFIG) {
    ...
    Restangular.extendModel(APP_CONFIG.apiRootUrl + api_url + '/todos.json', function (todo) {
    ...
    return Restangular.all(APP_CONFIG.apiRootUrl + api_url + '/todos.json')
});
"use strict";
    ...
    return {
        ...
        compile: function (element, attributes) {
            ...
            if (attributes.dateFormat)
                options.dateFormat = attributes.dateFormat;

            if (attributes.defaultDate)
                options.defaultDate = attributes.defaultDate;
